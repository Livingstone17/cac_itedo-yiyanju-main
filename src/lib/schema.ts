...
export const generateEventSchema = (event: { title: string; description: string; startDate: string; endDate?: string; location: string; isOnline?: boolean; image?: string }) => ({
  "@context": "https://schema.org",
  "@type": "Event",
  name: event.title,
...
export const generatePersonSchema = (person: { name: string; role: string; image?: string; email?: string; description?: string }) => ({
  "@context": "https://schema.org",
  "@type": "Person",
  name: person.name,
