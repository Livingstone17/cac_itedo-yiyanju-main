...
function StatItem({
  ...
  return (
    <div className="hero-stat text-center">
      <div className="bg-gradient-to-r from-[#d4a843] to-[#f0d78c] bg-clip-text text-3xl font-bold text-transparent md:text-4xl">
        {count}
        {suffix}
      </div>
        ...
        <div className="container mx-auto grid grid-cols-1 gap-8 px-6 lg:grid-cols-2 lg:gap-4">
          ...
          <div className="flex flex-col justify-center py-20 lg:py-0 lg:pr-8">
            ...
            <h1 className="mb-6 text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
              ...
              <span className="hero-title-line mt-1 block bg-gradient-to-r from-[#d4a843] via-[#f0d78c] to-[#d4a843] bg-clip-text text-transparent">
                CAC,
              </span>
              <span className="hero-title-line mt-1 block bg-gradient-to-r from-[#d4a843] via-[#f0d78c] to-[#d4a843] bg-clip-text text-transparent">
                Itedo Yiyanju
            ...
            <div className="hero-buttons mb-10 flex flex-col gap-3 sm:flex-row sm:gap-4">
              <Button
                ...
                className="group relative overflow-hidden rounded-xl border-0 bg-gradient-to-r from-[#d4a843] to-[#b8922e] px-8 py-6 text-base font-semibold text-[#0a1628] shadow-[0_0_30px_rgba(212,168,67,0.25)] transition-all duration-500 hover:shadow-[0_0_50px_rgba(212,168,67,0.4)]"
              >
          ...
          <div className="hero-3d relative flex items-center justify-center">
            ...
            {/* 3D Canvas */}
            <div className="h-[450px] w-full sm:h-[550px] lg:h-[600px]">
              <Canvas
