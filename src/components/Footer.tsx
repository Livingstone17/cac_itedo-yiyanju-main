...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#0a1628] text-white">
      {/* Top gradient line */}
      <div className="absolute left-0 right-0 top-0 h-px bg-gradient-to-r from-transparent via-[#d4a843]/30 to-transparent" />
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        />
        <div className="absolute -left-40 bottom-0 h-[400px] w-[400px] rounded-full bg-[#d4a843]/[0.03] blur-[140px]" />
        <div className="absolute -right-40 top-0 h-[300px] w-[300px] rounded-full bg-[#1a2f5a]/20 blur-[100px]" />
      </div>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 backdrop-blur-sm md:p-8">
            <div className="mb-6 flex items-center justify-center gap-3">
              <div className="h-px flex-1 max-w-[60px] bg-gradient-to-r from-transparent to-[#d4a843]/40" />
              <div className="flex items-center gap-2 rounded-full border border-[#d4a843]/20 bg-[#d4a843]/5 px-4 py-1.5">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#d4a843]">
                  Join Us To Fellowship
                </span>
              </div>
              <div className="h-px flex-1 max-w-[60px] bg-gradient-to-l from-transparent to-[#d4a843]/40" />
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {serviceTimes.map((s, i) => (
                <div
                  key={i}
                  className="group rounded-xl border border-white/5 bg-white/[0.02] p-4 text-center transition-all duration-500 hover:border-[#d4a843]/20 hover:bg-white/[0.04]"
                >
                  <span className="mb-1 block text-xs font-bold uppercase tracking-wider text-[#d4a843]">
                    {s.day}
                  </span>
                  <span className="block text-sm font-medium text-white/70">{s.service}</span>
                  <span className="mt-1 inline-block rounded-full bg-[#d4a843]/10 px-3 py-0.5 text-xs font-bold text-[#d4a843]">
                    {s.time}
                  </span>
                </div>
              ))}
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              <div className="mb-6 flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-[#d4a843] to-[#b8922e] shadow-md">
                  <img src={logo} alt="CAC Itedo Yiyanju logo" className="h-full w-full object-contain" />
                </div>
                <div>
                  <span className="block text-lg font-bold text-white">Itedo Yiyanju</span>
                  <span className="text-[10px] font-semibold uppercase tracking-[0.15em] text-[#d4a843]">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="group flex items-start gap-3">
                    ...
                    <span className="pt-1 text-sm text-white/40 transition-colors duration-300 group-hover:text-white/60">
                      {item.text}
                    </span>
                  </div>
                ))}
                ...
                {quickLinks.map((link, i) => (
                  <li key={i}>
                    <button
                      ...
                      className="group flex items-center gap-2 text-sm text-white/40 transition-all duration-300 hover:text-[#d4a843]"
                    >
            ...
            <div className="lg:col-span-4">
              ...
              >
                <Input
                  ...
                  className="flex-1 rounded-xl border-white/10 bg-white/5 text-sm text-white placeholder:text-white/25 focus:border-[#d4a843]/50 focus:ring-[#d4a843]/20"
                />
                <button
                  type="submit"
                  className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#d4a843] to-[#b8922e] text-[#0a1628] shadow-[0_0_15px_rgba(212,168,67,0.2)] transition-all duration-500 hover:shadow-[0_0_25px_rgba(212,168,67,0.35)]"
                >
              ...
              {/* Social links */}
              <div>
                <h5 className="mb-3 text-xs font-semibold uppercase tracking-wider text-white/30">
                  Follow Us
                </h5>
                  ...
                  {socialLinks.map((social, i) => {
                    ...
                    return (
                      <a
                        ...
                        className="group flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.06] bg-white/[0.02] transition-all duration-500 hover:border-[#d4a843]/30 hover:bg-[#d4a843]/10"
                      >
                        <Icon className="h-4 w-4 text-white/40 transition-colors duration-300 group-hover:text-[#d4a843]" />
                      </a>
                    );
                  })}
                </div>
      ...
      <div className="relative z-10 border-t border-white/[0.06]">
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-6 py-5 sm:flex-row">
          ...
          <p className="flex items-center gap-1 text-xs text-white/30">
            &copy; {new Date().getFullYear()} CAC Itedo Yiyanju.
            All rights reserved.
          </p>
          ...
          <button
            onClick={scrollToTop}
            className="group flex items-center gap-2 rounded-full border border-white/[0.06] bg-white/[0.02] px-4 py-1.5 text-xs text-white/30 transition-all duration-500 hover:border-[#d4a843]/20 hover:text-[#d4a843]"
          >
            Back to top
