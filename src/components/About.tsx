...
//       title: "Love",
//       description:
//         "We believe love is the foundation of everything we do, reflecting God's heart for humanity.",
//       icon: Heart,
//       color: "bg-red-500",
//     },
//     {
//       title: "Community",
//       description:
//         "We foster authentic relationships and support one another through life's journey.",
//       icon: Users,
//       color: "bg-church-blue",
//     },
//     {
//       title: "Purpose",
//       description:
//         "We help people discover and live out God's unique calling on their lives.",
//       icon: Compass,
//       color: "bg-church-gold",
//     },
//     {
//       title: "Growth",
//       description:
//         "We encourage spiritual maturity through biblical teaching and practical application.",
//       icon: BookOpen,
//       color: "bg-green-500",
//     },
//   ];
...
//         {/* Values */}
//         <div className="mb-20" ref={valuesContainerRef}>
//           <h3 className="text-3xl font-bold text-church-text text-center mb-12">Our Core Values</h3>
//           <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
//             {values.map((value, index) => {
//               const IconComponent = value.icon;
...
//                 <Card
//                   key={index}
//                   className="value-card text-center shadow-soft hover:shadow-medium transition-all duration-300 border-church-blue/10 group"
//                 >
//                   <CardContent className="p-6">
//                     <div
