...
//     // Assumes date like "Oct 12, 2025" and time like "10:00 AM"
//     const start = new Date(`${date} ${time}`);
//     const end = new Date(start.getTime() + 2 * 60 * 60 * 1000); // default 2h event
...
//       banner: "https://images.unsplash.com/photo-1513623954575-263b06149894?w=800",
//       description:
...
//               <CardHeader>
//                 <CardTitle className="text-2xl text-church-text">{event.title}</CardTitle>
//                 <p className="text-church-text-light mt-2">{event.description}</p>
//               </CardHeader>
