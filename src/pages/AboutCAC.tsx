        ...
        <div className="2xl:container mx-auto max-w-4xl px-4">
          ...
          <div className="reveal mb-20">
            <div className="relative border-l-4 border-church-gold pl-6">
              ...
              <div className="stagger space-y-6 leading-relaxed text-church-text-light">
                <div>
                  <h3 className="stagger-item mb-4 text-2xl font-bold text-church-text">Origin of Pentecostalism and the Birth of the Aladura Group</h3>
          ...
          <section id="tenets" className="reveal mb-20">
            <div className="relative border-l-4 border-church-gold pl-6">
              <h2 className="mb-8 text-4xl font-bold text-church-text">
              ...
              <div className="space-y-8 leading-relaxed text-church-text-light">
                ...
                <div className="mt-10 grid gap-6 md:grid-cols-2">
                  {/* Tenet 1 */}
                  <div className="stagger-item rounded-lg border border-border bg-card p-6 transition-all duration-300 hover:shadow-lg">
          ...
          {/* Call to Action */}
          <div className="reveal rounded-lg border border-church-gold/20 bg-gradient-to-r from-church-blue/10 to-church-gold/10 p-8 text-center">
            ...
            <HashLink smooth to="/#contact" className="inline-block rounded-lg bg-church-gold px-8 py-3 font-semibold text-white transition-colors duration-300 hover:bg-church-gold/90">
              Contact Us
            </HashLink>
          </div>
        </div>
