...
export default function AboutCACPage() {
  ...
  return (
    <>
      <section className="bg-background pb-20 pt-32" id="cac-history">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="mb-20">
            <div className="relative border-l-4 border-church-gold pl-6">
              ...
              <div className="space-y-6 leading-relaxed text-church-text-light">
                <div>
                  <h3 className="mb-4 text-2xl font-bold text-church-text">Origin of Pentecostalism and the Birth of the Aladura Group</h3>
          ...
          <section id="tenets" className="mb-20">
            <div className="relative border-l-4 border-church-gold pl-6">
              <h2 className="mb-8 text-4xl font-bold text-church-text">
