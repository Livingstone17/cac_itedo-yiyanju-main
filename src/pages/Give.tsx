...
const GivePage: React.FC = () => {
  ...
  return (
    <div ref={pageRef} className="bg-light-200 dark:bg-dark-300 min-h-screen">
      {/* Hero */}
      <section
      ...
      >
        <div className="from-church-blue-900/80 via-church-blue-900/60 to-dark-300/90 absolute inset-0 bg-linear-to-b" />

        <div className="relative z-10 container mx-auto px-6 py-20 text-center">
          <div className="mx-auto max-w-3xl">
            <div className="border-light/20 bg-light/10 text-light/90 mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium backdrop-blur-sm">
              <Heart className="h-4 w-4 text-red-400" />
              <span>Partner with God's Work</span>
            </div>

            <h1 className="hero-title text-light mb-6 text-4xl leading-tight font-bold md:text-6xl lg:text-7xl">
              Your Giving.
              <br />
              <span className="text-church-gold-300">Eternal Impact.</span>
            </h1>

            <p className="hero-subtitle text-light/80 mx-auto mb-8 max-w-2xl text-lg leading-relaxed md:text-xl">Join us in advancing the Kingdom through your generous support. Every seed sown produces a harvest of righteousness.</p>
            ...
            <div className="hero-cta flex flex-col justify-center gap-4 sm:flex-row">
              ...
              <Button
                size="lg"
                className="border-light/30 bg-light/10 text-light hover:bg-light/20 border backdrop-blur-sm"
                onClick={() => {
                  setActiveTab("branch");
                  document.getElementById("giving-tabs")?.scrollIntoView({ behavior: "smooth" });
                }}
